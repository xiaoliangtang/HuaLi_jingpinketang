...
<head>
	...
	<link href="/immigration/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
    <link href="/immigration/statics/simpleboot/css/simplebootadmin.css" rel="stylesheet">
    <link href="/immigration/statics/js/artDialog/skins/default.css" rel="stylesheet" />
    <link href="/immigration/statics/simpleboot/font-awesome/4.2.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
    <style>
	...
	<!--[if IE 7]>
	<link rel="stylesheet" href="/immigration/statics/simpleboot/font-awesome/4.2.0/css/font-awesome-ie7.min.css">
	<![endif]-->
...
<!-- Le javascript
    ...
    <script src="/immigration/statics/js/jquery.js"></script>
    <script src="/immigration/statics/js/wind.js"></script>
    <script src="/immigration/statics/simpleboot/bootstrap/js/bootstrap.min.js"></script>
		...
		<div class="common-form">
			<form method="post" class="form-horizontal J_ajaxForm" action="<?php echo U('nav/edit_post');?>">
				...
				<div class="form-actions">
					...
					<a class="btn" href="/immigration/index.php/Admin/Nav">返回</a>
				</div>
			</form>
		</div>
	</div>
	<script src="/immigration/statics/js/common.js"></script>
	<script>
		$(function() {
