...
// +----------------------------------------------------------------------
namespace plugins\Config\Controller; //Config插件英文名，改成你的插件英文就行了
...
class AdminIndexController extends PluginController{
	...
	function index(){
		//$plugin_Config_model=D("plugins://Config/PluginConfig");//实例化自定义模型PluginConfig ,需要创建plugin_Config表
		//$plugin_Config_model->test();//调用自定义模型PluginConfig里的test方法
